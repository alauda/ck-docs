...
An instance of Alauda Analytical Database E1 is one `ClickHouseInstallation` (CHI) resource. The operator converts it into StatefulSets, Services, ConfigMaps and PersistentVolumeClaims.
